...
//todo: write test to code:
//todo: support multiple solo modes


/*exports.playSoloLocally = function (, executionDetails, playCallback) {

 //execid
 var widgetObjectIdList = _.map(widgetIdArray, function (widgetId) {
 managers.db.toObjectId(widgetId);
 });
 logger.trace("Liron is here " + playCallback(widgetObjectIdList));
 playCallback(widgetObjectIdList);
